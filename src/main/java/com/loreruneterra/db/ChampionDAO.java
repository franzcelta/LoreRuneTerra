...
public class ChampionDAO {
    ...
    // Carga la biografía más reciente
    public String getBiografia(String keyCampeon) {
        try (Connection conn = DatabaseConnector.getConnection()) {
            String sql = """
    ...
    // Guarda o actualiza biografía
    public void saveBiografia(String keyCampeon, String texto) {
        try (Connection conn = DatabaseConnector.getConnection()) {
